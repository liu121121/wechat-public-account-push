...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx6364c5cdb53a2dff',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '6949d2e4497e30971bbf23319cb01c62',
  ...
  USERS: [
    {
      ...
      id: 'oBWLm6MS1hLR3-TEZFqSqomSayK8',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'j6aAfTvG2j1M8PXGynO5MUoQO-_smr2L1-IeOYYr6j0',
      // 所在省份
      province: '河南',
      // 所在城市
      city: '洛阳',
      ...
      openUrl: 'https://translate.google.cn/',
      // 专属节日提醒，如果你在这里填写了节日提醒，就不会执行FESTIVALS的提醒了, 和FESTIVALS的配置方法相同，可以往下查看，我这里就不重复写了
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {
          type: '*生日', name: '小张', year: '1998', date: '11-17',
        },
        //{
        ...
        {
          type: '*生日', name: '小刘', year: '2000', date: '09-24',
        },
        //{
      ...
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2019-08-07' },
        // 结婚纪念日
  ...
  CALLBACK_USERS: [
    {
      ...
      id: 'oBWLm6EdZJTpSwV-06gO0URWQHes',
    }
    // 你可以不断按格式往下增加
    // ...
  ],
